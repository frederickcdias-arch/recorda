          ...
          <>
            {devolucao.observacoes ? (
              <div className="rounded-xl border border-[var(--color-border-primary)] bg-[var(--color-bg-secondary)] p-4">
                <p className="text-xs font-medium text-[var(--color-text-tertiary)]">Observações</p>
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
              {itens.map((item, index) => (
                <div
                  key={item.id}
                  className="rounded-xl border border-[var(--color-border-primary)] bg-[var(--color-bg-primary)] p-4 shadow-xs lg:hidden"
                >
                  <div className="mb-3 flex items-start justify-between gap-3">
                    ...
                    <span className="rounded-full bg-[var(--color-bg-tertiary)] px-2 py-1 text-xs font-medium text-[var(--color-text-secondary)]">
                      {item.volume || '—'}
                    </span>
                  </div>
