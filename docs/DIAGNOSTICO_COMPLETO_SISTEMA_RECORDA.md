...
7. Auditoria → Importações, OCR, Correções *(sem Ações de Usuários)*
...
| `tipos_ausencia` | migration 074 | *sem backend de CRUD* | ⚠️ Apenas seeds |
...
*Relatório gerado por análise estática completa do repositório. Versão: 1.0*
